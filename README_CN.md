...
dependencies {
    implementation 'com.phantomvk.slideback:slideback:0.2.8'
}
```
...
dependencies {
    implementation 'com.phantomvk.slideback:slideback-support:0.2.8'
}
```
